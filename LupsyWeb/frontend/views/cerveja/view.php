...
<div class="cerveja-view custom-view">
                ...
                <div class="card shadow-sm p-4">
                    ...
                    <?php if (Yii::$app->user->isGuest): ?>
                        <div class="alert alert-warning text-center">
                            Você precisa estar <a href="<?= \yii\helpers\Url::to(['site/login']) ?>" class="alert-link">logado</a> para avaliar.
                        </div>
                    <?php else: ?>
                        <!-- Inicia o formulário de avaliação -->
                        <?php $form = ActiveForm::begin(['action' => ['cerveja/rate', 'id' => $model->id], 'method' => 'post']); ?>

                        <div class="rating text-center my-3">
                            <span data-rating="1" class="star"><i class="fa fa-star"></i></span>
                            <span data-rating="2" class="star"><i class="fa fa-star"></i></span>
                            <span data-rating="3" class="star"><i class="fa fa-star"></i></span>
                            <span data-rating="4" class="star"><i class="fa fa-star"></i></span>
                            <span data-rating="5" class="star"><i class="fa fa-star"></i></span>
                        </div>

                        <?= Html::hiddenInput('nota', '', ['id' => 'nota']) ?>

                        <div class="text-center">
                            <?= Html::submitButton('Avaliar', ['class' => 'btn btn-warning btn-lg', 'id' => 'submitBtn']) ?>
                        </div>
                    ...
                    <h3 class="text-center">Avaliação Média</h3>
                    <?php if (!empty($mediaNota)): ?>
                        <p class="text-center">Média: <strong><?= number_format($mediaNota, 1) ?></strong></p>
                    <?php else: ?>
            ...
            $this->registerJs("
                $(document).ready(function() {
                    $('.star').on('click', function() {
                        ...
                        $('#nota').val(rating); // Set the hidden input value with the rating
                        $('.star').each(function() {
        ...
        <div class="container-fim">
            ...
            <div class="detail-item-notop">
                ...
                <button class="card-btn-nobrd" onclick="addToHistoricoBebi(<?= Yii::$app->user->id ?>, <?= $model->id ?>)">
                    <svg viewBox="0 -73.35 392.137 392.137" width="40px" xmlns="http://www.w3.org/2000/svg" fill="#000000">
                        ...
                        <g id="SVGRepo_iconCarrier">
                            ...
                            <path class="b" d="M169.023,220.475c-11.6,4.3-48.854,8.447-59.318,6.824L99.087,135.21c5.666-5.718,15.117-5.8,22.883-3.686s15.566,5.538,23.537,4.418a21.483,21.483,0,0,0,13.791-7.97Z"></path>
                            ...
                            <path class="c" d="M66.121,173.679c6.405-2.182,13.021-3.7,19.487-5.683,2.946-.9,1.69-5.537-1.276-4.628-6.466,1.98-13.082,3.5-19.487,5.683A2.455,2.455,0,0,0,63.169,172a2.422,2.422,0,0,0,2.952,1.676Z"></path>
                            <path class="c" d="M69.3,188.259c5.86-1.769,11.83-3.21,17.643-5.132a2.454,2.454,0,0,0,1.676-2.952,2.424,2.424,0,0,0-2.952-1.676c-5.813,1.922-11.783,3.362-17.643,5.132a2.4,2.4,0,1,0,1.276,4.628Z"></path>
                            <path class="c" d="M72.616,200.586c4.818-1.554,9.7-2.909,14.518-4.451a2.4,2.4,0,0,0-1.276-4.629c-4.821,1.542-9.7,2.9-14.518,4.452a2.4,2.4,0,1,0,1.276,4.628Z"></path>
.673.13-1.011a11.7,11.7,0,0,0-.23-3.651c-.931-4.167-4.6-6.889-8.587-7.853a66.973,66.973,0,0,0-7-1.06q-3.795-.5-7.6-.907c-4.934-.542-9.876-1.01-14.82-1.449q-15.646-1.389-31.332-1.674c-4.521-.08-9.256-.308-12.971,2.718-2.874,2.341-3.739,5.821-4.11,9.343-1.01,9.589-1.783,19.208-2.609,28.814q-1.821,21.177-3.509,42.364c-.818,10.3-1.7,20.6-2.248,30.916a64.267,64.267,0,0,0-.07,8.3,2.46,2.46,0,0,0,2.4,2.4A2.419,2.419,0,0,0,225.74,218.033Z"></path>
                            <path class="c" d="M322.491,197.324a57.645,57.645,0,0,1-4.543,4.5q-1.191,1.055-2.441,2.04c-.013.01-.464.36-.179.141s-.17.129-.183.139c-.214.162-.43.323-.646.482q-.692.508-1.4,1a2.4,2.4,0,1,0,2.422,4.144,59.639,59.639,0,0,0,10.361-9.052,2.4,2.4,0,0,0-3.394-3.394Z"></path>
                            <path class="c" d="M326.013,129.444a29.435,29.435,0,0,0-4.292-1.716,2.4,2.4,0,0,0-2.711,3.525,2.579,2.579,0,0,0,1.435,1.1c.831.262,1.651.556,2.455.893l-.574-.242q.64.271,1.264.581a2.552,2.552,0,0,0,1.85.242,2.448,2.448,0,0,0,1.434-1.1,2.423,2.423,0,0,0,.242-1.849,2.387,2.387,0,0,0-1.1-1.434Z"></path>
    ...
    <div class="comentarios mt-4">
        <h3 class="title-c">Comentários</h3>
        <?php if (!empty($comentarios)): ?>
            <div class="list-group">
                <?php foreach ($comentarios as $comentario): ?>
                    <div class="list-group-item list-group-item-action mb-2 shadow-sm">
                        <div class="d-flex w-100 justify-content-between">
                            <h5 class="nome-comment"><?= Html::encode($comentario->utilizador->nome ?? 'Anônimo') ?></h5>
                            <small class="text-muted"><?= Yii::$app->formatter->asDatetime($comentario->data) ?></small>
                        </div>
                        <p class="mb-1 text-secondary"><?= Html::encode($comentario->comentario) ?></p>
                    </div>
                <?php endforeach; ?>
            </div>
        <?php else: ?>
            <div class="alert alert-info" role="alert">
                <i class="fas fa-info-circle"></i> Sem comentários para esta cerveja.
            </div>
        <?php endif; ?>
        ...
        <div class="comentario-form">
            <?php if (!Yii::$app->user->isGuest): ?>
                ...
                <?= $form->field($novoComentario, 'comentario')->textarea([
                    'rows' => 3,
                    'placeholder' => 'Escreva seu comentário aqui...',
                ])->label(false) ?>

                <?= Html::hiddenInput('id_cerveja', $model->id) ?> <!-- ID da cerveja -->

                <?= Html::submitButton(
                    '<div class="svg-wrapper-1 btn-send">
            <svg
    ...
    ',
            ...
            <?php else: ?>
                <div class="alert alert-warning" role="alert">
                    <i class="fas fa-exclamation-circle"></i> Você precisa estar logado para enviar um comentário.
                    <?= Html::a('Clique aqui para entrar', ['site/login'], ['class' => 'btn btn-link']) ?>
                </div>
            <?php endif; ?>
        </div>
    </div>
